...
<div>
       <div class="gnb_wrap" >
           ...
           <div>
              <div>
                  <img  id="logo_img" src="http://localhost:9090/murkit/images/logo_nonBack.png" />
              </div>
              <div class="gnb_menu">
                  <ul class="list_gmenu" >
                     <li><a href="http://localhost:9090/murkit/murkit_intro.do" >먹킷소개</a></li>
                     ...
                     <li><a href="http://localhost:9090/murkit/my_info_update.do">MY먹킷</a></li>
                  </ul>
