...
<style>
	...
	#shipMgm_wrap #ship_item {border: 1px solid #ccc;}
	#shipMgm_wrap #ship_item #basic_ship{ color:green;}
	#shipMgm_wrap #ship_item_top {margin: 20px 15px; border-bottom: 1px solid black;}
	#shipMgm_wrap #ship_item_bottom {margin: 20px 15px;}
	#shipMgm_wrap #ship_item #ship_item_top p{width:750px; display:inline-block;}
	#shipMgm_wrap #ship_item #ship_item_top div {width:100px; margin-left:62px; border:1px solid #ccc; display: inline-block;}
	#shipMgm_wrap #ship_item #ship_item_top div a{color:black;}
	#shipMgm_wrap #ship_item #ship_item_top div span{ display: inline-block; padding: 7px 35px;}
